...
assertEqual(defaults.defaultsVersion, "0.8.0-v06-input-restore-ui-polish-test-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.0-experimental", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 9, "shipping manifest revision")
