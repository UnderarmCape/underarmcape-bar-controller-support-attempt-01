...
assertEqual(defaults.defaultsVersion, "0.8.0-native-widget-unification-test-1", "shipping defaults revision")
...
assertEqual(manifest.revision, 7, "shipping manifest revision")
