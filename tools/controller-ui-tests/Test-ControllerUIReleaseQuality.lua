...
assertEqual(defaults.defaultsVersion, "0.7.0-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.7.0", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 5, "shipping manifest revision")
...
print("Controller UI v0.7.0 release-quality tests passed: streamlined runtime, Disassemble hints, stat icons, semantic radial typography, and revision-5 defaults.")
