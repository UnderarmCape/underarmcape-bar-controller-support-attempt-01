...
assertEqual(defaults.defaultsVersion, "0.8.3-smartx-insert-tactical-repair-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.3-experimental", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 11, "shipping manifest revision")
