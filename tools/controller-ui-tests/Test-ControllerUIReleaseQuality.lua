...
assertEqual(defaults.defaultsVersion, "0.8.2-tactical-insert-idle-repair-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.2-experimental", "shipping defaults compatible mod")
