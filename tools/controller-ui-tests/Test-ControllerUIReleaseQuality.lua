...
assertEqual(defaults.defaultsVersion, "0.8.5-unit-insert-quota-type-navigation-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.5-experimental", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 13, "shipping manifest revision")
...
assertTrue(shippedHints.scale > 1 and shippedHints.fontScale > 1 and shippedHints.iconScale > 1,
	"input-polish defaults restore larger hints")
...
print("Controller UI release-quality tests passed: readable hint defaults, streamlined runtime, stat icons, and semantic radial typography.")
