...
assertEqual(defaults.defaultsVersion, "0.8.1-disassemble-idle-hints-polish-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.1-experimental", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 10, "shipping manifest revision")
