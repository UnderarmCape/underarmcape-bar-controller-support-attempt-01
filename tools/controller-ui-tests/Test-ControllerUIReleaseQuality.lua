...
assertEqual(defaults.defaultsVersion, "0.8.4-general-insert-disassemble-idle-1", "shipping defaults revision")
assertEqual(defaults.compatibleModVersion, "0.8.4-experimental", "shipping defaults compatible mod")
...
assertEqual(manifest.revision, 12, "shipping manifest revision")
