...
assertEqual(defaults.defaultsVersion, "0.8.0-native-input-polish-test-1", "shipping defaults revision")
...
assertEqual(manifest.revision, 6, "shipping manifest revision")
