...
local releaseNotes = read("tools/release/bar-controller-support-v0.8.3/RELEASE_NOTES_v0.8.3.md")
local releaseReadme = read("tools/release/bar-controller-support-v0.8.3/README.md")
...
-- Release/regressions.
test(95, "bridge reports v0.8.3", function() return has(props, ">0.8.3<") and has(companionTests, "BAR Controller Bridge v0.8.3 Experimental") end)
test(96, "updater discovers v0.8.3", function() return has(companionTests, "LatestRelease") and has(companionTests, "tag_name") and has(companionTests, "v0.8.3") end)
test(97, "Recovery Mode lists v0.8.3 first", function() return has(releaseSystem, "controller-support-v0.8.3-smartx-insert-tactical-repair") and has(releaseSystem, "Recovery Mode lists v0.8.3 first") end)
test(98, "v0.8.2 remains available", function() return has(releaseV082Readme, "v0.8.2") and has(releaseSystem, "v0.8.2 remains available") end)
...
test(115, "GitHub publication validation passes", function() return has(releaseSystem, "GitHub publication validation passes") and all(releaseSpec, "0.8.3", "SMARTX_INSERT_TACTICAL_REPAIR") and has(releaseNotes, "Smart X") and has(releaseReadme, "v0.8.3") end)
