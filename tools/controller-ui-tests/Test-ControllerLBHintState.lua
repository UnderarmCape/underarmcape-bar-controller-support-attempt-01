...
test("11 releasing RB confirms", function()
	contains(camera, 'ControllerCameraTestActionReleased("buildRadial")', "RB release")
...
test("25 shipping defaults enable tested stabilization", function()
	contains(defaults, '"defaultsVersion": "0.8.5-unit-insert-quota-type-navigation-1"', "defaults revision")
