...
$target = Join-Path $packageRoot "BAR_Controller_Support_v0.5.1_Widget_Companion"
$zipPath = Join-Path $packageRoot "BAR_Controller_Support_v0.5.1_Widget_Companion.zip"
...
$copies = [ordered]@{
    (Join-Path $WorkspaceRoot "tools\controller-companion\publish\installer\BAR_Controller_Companion_Installer_v0.5.1.exe") =
        (Join-Path $targetFullPath "BAR_Controller_Companion_Installer_v0.5.1.exe")
    (Join-Path $WorkspaceRoot "tools\controller-companion\publish\restore\BAR_Controller_Companion_Restore_v0.5.1.exe") =
        (Join-Path $targetFullPath "BAR_Controller_Companion_Restore_v0.5.1.exe")
    (Join-Path $PSScriptRoot "Install_BAR_Controller_Companion_v0.5.1.ps1") =
        (Join-Path $targetFullPath "tools\dev-scripts\Install_BAR_Controller_Companion_v0.5.1.ps1")
    (Join-Path $PSScriptRoot "Restore_BAR_Controller_Companion_v0.5.1.ps1") =
        (Join-Path $targetFullPath "tools\dev-scripts\Restore_BAR_Controller_Companion_v0.5.1.ps1")
    ...
    (Join-Path $WorkspaceRoot "doc\controller-companion-v0.5.1\README.md") =
        (Join-Path $targetFullPath "docs\README.md")
    (Join-Path $WorkspaceRoot "doc\controller-companion-v0.5.1\RELEASE_NOTES_v0.5.1.md") =
        (Join-Path $targetFullPath "docs\RELEASE_NOTES_v0.5.1.md")
    (Join-Path $WorkspaceRoot "doc\controller-companion-v0.5.1\PACKAGE_INVENTORY_v0.5.1.md") =
        (Join-Path $targetFullPath "docs\PACKAGE_INVENTORY_v0.5.1.md")
    (Join-Path $WorkspaceRoot "doc\controller-companion-v0.5.1\GAMEPLAY_FIX_VALIDATION.md") =
        (Join-Path $targetFullPath "docs\GAMEPLAY_FIX_VALIDATION_v0.5.1.md")
}
