...
$packageRoot = Join-Path $PackageArtifactsRoot "BAR_Controller_Support_v0.5.1_Widget_Companion"
$installer = Join-Path $packageRoot "BAR_Controller_Companion_Installer_v0.5.1.exe"
$restore = Join-Path $packageRoot "BAR_Controller_Companion_Restore_v0.5.1.exe"
