# BAR Controller Support v0.8.1 Experimental

Install with `BAR_Controller_Companion_Installer_v0.8.1_Experimental.exe` from the extracted package. The installer consumes `controller-release-manifest.json`, validates every dynamic component, creates a recovery backup, and never launches or terminates BAR.
