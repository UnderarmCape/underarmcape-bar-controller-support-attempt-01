...
Write-Output 'BAR was not launched. Widgets, Lua support modules, controller glyph/stat assets, defaults, and runtime files were restored or moved to rollback artifacts from the deployment manifest.'
