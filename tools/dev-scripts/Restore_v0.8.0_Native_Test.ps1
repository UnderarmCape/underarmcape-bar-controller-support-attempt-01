...
if ($manifest.kind -notin @('bar-controller-native-test-deployment-backup', 'bar-controller-native-hybrid-test-deployment-backup', 'bar-controller-native-hybrid-targeting-test-deployment-backup') -or $manifest.schemaVersion -ne 1) { throw 'Unexpected deployment manifest.' }
