...
internal static class Program
{
    ...
    {
        Console.Title = "BAR Controller Companion Installer " + ProductMetadata.DisplayVersion;
        ...
        out string? temporaryUpdateRoot)
    {
        ...
        try
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd(
                "BAR-Controller-Companion-Installer/" + ProductMetadata.SemanticVersion);
    ...
    {
        Console.Error.WriteLine(
            "Usage: " + ProductMetadata.InstallerFileName + " "
