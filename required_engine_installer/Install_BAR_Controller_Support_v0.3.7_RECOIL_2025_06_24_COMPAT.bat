...
if /I not "%~1"=="__RUN__" (
    ...
    set "BOOT_LOG=%USERPROFILE%\Desktop\BAR_Controller_Install_v0.3.7_RECOIL_2025_06_24_COMPAT_SAFE_LIVE_!BOOT_STAMP!.log"

    echo ============================================================
    echo BAR Controller Support v0.3.7 - Recoil 2025.06.24 Compatibility SAFE LIVE Installer
    echo ============================================================
    echo.
...
set "INSTALL_LOG=%~2"
title BAR Controller Support v0.3.7 - Recoil 2025.06.24 Compatibility SAFE LIVE Installer
...
echo It uses the Recoil 2025.06.24 compatibility engine build with the reviewed PR #2985 API and the matching BAR controller widget.
...
set "BAR_RELEASE_TAG=controller-support-v0.3.7-recoil-2025-06-24-compat"
...
set "WORK=%TEMP%\BAR-Controller-Support-v0.3.7-RECOIL-2025-06-24-COMPAT-SAFE-%STAMP%"
...
if exist "%LOCAL_WIDGET%" (
    ...
    echo Downloading matching widget from BAR controller support v0.3.7 release...
    echo.
    echo URL:
    echo "%WIDGET_URL%"
    echo.
