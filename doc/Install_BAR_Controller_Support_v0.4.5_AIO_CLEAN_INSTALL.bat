...
set "INSTALLER_NAME=BAR Controller Support v0.4.5 - AIO Clean Install"
set "ENGINE_SLOT=recoil_2025.06.24"
set "SELF_DIR=%~dp0"
if "%SELF_DIR:~-1%"=="\" set "SELF_DIR=%SELF_DIR:~0,-1%"
set "EXTRACTED_PAYLOAD_ROOT=%SELF_DIR%\payload"
set "PAYLOAD_ZIP_PATTERN=BAR_Controller_Support_v0.4.5_AIO_PAYLOAD_*.zip"
set "PAYLOAD_ROOT="
set "PAYLOAD_ENGINE="
set "PAYLOAD_BAR="
set "PAYLOAD_LUA="
...
set "LOG_FILE=%DESKTOP%\BAR_Controller_v0.4.5_AIO_CLEAN_INSTALL_%STAMP%.log"
...
set "BACKUP=%BAR_DATA%\controller-support-v045-aio-clean-backups\%STAMP%"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$ErrorActionPreference='Stop'; $dir=$env:SELF_DIR; $p1=Join-Path $dir 'BAR_Controller_Support_v0.4.5_AIO_PAYLOAD_1_OF_2.zip'; $p2=Join-Path $dir 'BAR_Controller_Support_v0.4.5_AIO_PAYLOAD_2_OF_2.zip'; $h1=(Get-FileHash -Algorithm SHA256 -LiteralPath $p1).Hash; $h2=(Get-FileHash -Algorithm SHA256 -LiteralPath $p2).Hash; if ($h1 -ne 'EE1A5AEF034E4ED2DEBBE07CC87ED78D75659C95C3932CF5DB2CD403E4CF9EB3') { throw ('Hash mismatch for PAYLOAD_1_OF_2.zip. Expected EE1A5AEF034E4ED2DEBBE07CC87ED78D75659C95C3932CF5DB2CD403E4CF9EB3, got ' + $h1) }; if ($h2 -ne '18E525AABC4B36D900688D9C4CC91DA4A39AF5FDB5B5F3E5FC8E84206E1E333E') { throw ('Hash mismatch for PAYLOAD_2_OF_2.zip. Expected 18E525AABC4B36D900688D9C4CC91DA4A39AF5FDB5B5F3E5FC8E84206E1E333E, got ' + $h2) }; Write-Host 'Payload hashes verified successfully.'"
if errorlevel 1 (
...
echo devmode enabled by BAR Controller Support v0.4.5 AIO Clean Install> "%BAR_DATA%\devmode.txt"
if errorlevel 1 (
